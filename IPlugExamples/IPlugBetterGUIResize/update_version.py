...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugBetterGUIResize-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugBetterGUIResize-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugBetterGUIResize-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugBetterGUIResize-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugBetterGUIResize-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugBetterGUIResize-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugBetterGUIResize-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugBetterGUIResize.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugBetterGUIResize.iss",inplace=1):
