...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright ChangeME, " + str(today.year)
  ...
  plistpath = scriptpath + "/resources/IPlugSpectFFT-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSpectFFT-RTAS-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugSpectFFT-IOSAPP-Info.plist"
