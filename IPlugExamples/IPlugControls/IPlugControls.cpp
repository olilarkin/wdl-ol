  ...
  : IPLUG_CTOR(kNumParams, kNumPrograms, instanceInfo)
{
  ...
  IBitmap* bitmap = pGraphics->LoadPointerToBitmap(ISWITCHCONTROL_2_ID, ISWITCHCONTROL_2_FN, kISwitchControl_2_N);
  pGraphics->AttachControl(new ISwitchControl(this, kISwitchControl_2_X, kISwitchControl_2_Y, kISwitchControl_2, bitmap));

  // Attach the ISwitchControl 2 image "switch"
  bitmap = pGraphics->LoadPointerToBitmap(ISWITCHCONTROL_3_ID, ISWITCHCONTROL_3_FN, kISwitchControl_3_N);
  ...
  bitmap = pGraphics->LoadPointerToBitmap(IRADIOBUTTONSCONTROL_ID, IRADIOBUTTONSCONTROL_FN, kIRadioButtonsControl_N);
  ...
  bitmap = pGraphics->LoadPointerToBitmap(ICONTACTCONTROL_ID, ICONTACTCONTROL_FN, kIContactControl_N);
  ...
  bitmap = pGraphics->LoadPointerToBitmap(IFADERCONTROL_HORIZ_ID, IFADERCONTROL_HORIZ_FN);
  ...
  bitmap = pGraphics->LoadPointerToBitmap(IFADERCONTROL_VERT_ID, IFADERCONTROL_VERT_FN);
  ...
  bitmap = pGraphics->LoadPointerToBitmap(IKNOBROTATERCONTROL_ID, IKNOBROTATERCONTROL_FN);
  ...
  bitmap = pGraphics->LoadPointerToBitmap(IKNOBMULTICONTROL_ID, IKNOBMULTICONTROL_FN, kIKnobMultiControl_N);
  ...
  IBitmap* base = pGraphics->LoadPointerToBitmap(IKRMC_BASE_ID, IKRMC_BASE_FN);
  IBitmap* mask = pGraphics->LoadPointerToBitmap(IKRMC_MASK_ID, IKRMC_MASK_FN);
  IBitmap* top = pGraphics->LoadPointerToBitmap(IKRMC_TOP_ID, IKRMC_TOP_FN);
  ...
  //Attach IBitmap*OverlayControl
  bitmap = pGraphics->LoadPointerToBitmap(IBOC_ID, IBOC_FN);
